  ...
  return (
    <div className="px-[18px] pb-12 text-ink relative">
        ...
        <a
          ...
          className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-all duration-200 hover:scale-110 hover:shadow-[0_8px_30px_rgba(37,211,102,0.4)] active:scale-95"
        ...
        <main>
          ...
          <motion.section
            id="about"
            className="mt-5 sm:mt-7 rounded-lg border border-ink/10 bg-white/70 px-4 sm:px-[18px] py-5 sm:py-7 shadow-[0_18px_50px_rgba(40,24,18,0.08)]"
            variants={sectionVariants}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.2 }}
          >
            <div className="grid gap-6 sm:gap-8 md:grid-cols-[1fr_280px] md:items-start">
              <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                <motion.h2 variants={staggerItem} className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold leading-none text-oxblood">About</motion.h2>
                <motion.p variants={staggerItem} className="mt-2 text-xs sm:text-sm text-muted">Short, direct positioning built from the bio you shared.</motion.p>
                <motion.p variants={staggerItem} className="mt-4 sm:mt-5 max-w-2xl text-sm sm:text-base leading-relaxed text-muted">
          ...
          >
            <div>
              <motion.h2
                className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold leading-none text-oxblood"
